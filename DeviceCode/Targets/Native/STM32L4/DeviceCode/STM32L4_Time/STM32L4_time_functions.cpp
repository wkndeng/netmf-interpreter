...
#if STM32L4_32B_TIMER == 2
    #define TIM_32 TIM2
    #define RCC_APB1ENR_TIM_32_EN RCC_APB1ENR1_TIM2EN
    #define DBGMCU_APB1_FZ_DBG_TIM_32_STOP DBGMCU_APB1FZR1_DBG_TIM2_STOP
    #define TIM_32_IRQn TIM2_IRQn
    #if STM32L4_16B_TIMER == 3
        #define TIM_16 TIM3
        #define RCC_APB1ENR_TIM_16_EN RCC_APB1ENR1_TIM3EN
        #define TIM_SMCR_TS_BITS (TIM_SMCR_TS_0 * 1) // TS = 001
    #elif STM32L4_16B_TIMER == 4
        #define TIM_16 TIM4
        #define RCC_APB1ENR_TIM_16_EN RCC_APB1ENR1_TIM4EN
        #define TIM_SMCR_TS_BITS (TIM_SMCR_TS_0 * 1) // TS = 001
    #elif STM32L4_16B_TIMER == 8
        #define TIM_16 TIM8
        #define RCC_APB2ENR_TIM_16_EN RCC_APB2ENR1_TIM8EN
        #define TIM_SMCR_TS_BITS (TIM_SMCR_TS_0 * 1) // TS = 001
    #elif STM32L4_16B_TIMER == 9
        #define TIM_16 TIM9
        #define RCC_APB2ENR_TIM_16_EN RCC_APB2ENR1_TIM9EN
        #define TIM_SMCR_TS_BITS (TIM_SMCR_TS_0 * 0) // TS = 000
    #else
        #error wrong 16 bit timer (3, 4, 8 or 9)
    #endif
#elif STM32L4_32B_TIMER == 5
    #define TIM_32 TIM5
    #define RCC_APB1ENR_TIM_32_EN RCC_APB1ENR_TIM5EN
    #define DBGMCU_APB1_FZ_DBG_TIM_32_STOP DBGMCU_APB1FZR1_DBG_TIM5_STOP
    #define TIM_32_IRQn TIM5_IRQn
    #if STM32L4_16B_TIMER == 1
        #define TIM_16 TIM1
        #define RCC_APB2ENR_TIM_16_EN RCC_APB2ENR_TIM1EN
        #define TIM_SMCR_TS_BITS (TIM_SMCR_TS_0 * 0) // TS = 000
    #elif STM32L4_16B_TIMER == 3
        #define TIM_16 TIM3
...
//#ifdef RCC_APB1ENR_TIM_16_EN
    RCC->APB1ENR1 |= RCC_APB1ENR_TIM_32_EN | RCC_APB1ENR_TIM_16_EN;
//#else
//    RCC->APB1ENR1 |= RCC_APB1ENR_TIM_32_EN;
//    RCC->APB2ENR |= RCC_APB2ENR_TIM_16_EN;
//#endif

    // configure jtag debug support
    DBGMCU->APB1FZR1 |= DBGMCU_APB1_FZ_DBG_TIM_32_STOP;
...
//
#define STM32L4_SLEEP_USEC_FIXED_OVERHEAD_CLOCKS 3
...
void __section("SectionForFlashOperations") HAL_Time_Sleep_MicroSeconds( UINT32 uSec )
{
    ...
    if(maxDiff <= STM32L4_SLEEP_USEC_FIXED_OVERHEAD_CLOCKS) maxDiff  = 0;
    else maxDiff -= STM32L4_SLEEP_USEC_FIXED_OVERHEAD_CLOCKS;
