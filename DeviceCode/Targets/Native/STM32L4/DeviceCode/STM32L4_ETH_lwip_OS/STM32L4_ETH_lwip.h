...
/*********************************************************************************************
 * @file    STM32L4_ETH_lwip.h
 * @brief   Interface between the LWIP module and the STM32L4 ethernet driver.
 * @author  CSA Engineering AG, Switzerland, www.csa.ch, info@csa.ch
 * @date    March 2012
 ********************************************************************************************/
  
#ifndef STM32L4_ETH_LWIP_H
#define STM32L4_ETH_LWIP_H
...
#  define eth_input(n) netifapi_netif_common( n, STM32L4_ETH_LWIP_recv, NULL)
#  if LWIP_DHCP
...
BOOL STM32L4_ETH_LWIP_open(Netif_t *const pNetif);
void STM32L4_ETH_LWIP_close(const BOOL disableClocks);
void STM32L4_ETH_LWIP_recv(Netif_t *const pNetif);
err_t STM32L4_ETH_LWIP_xmit(Netif_t *const pNetif, Pbuf_t *const pBuf);
void STM32L4_ETH_LWIP_interrupt(Netif_t *const pNetif);
