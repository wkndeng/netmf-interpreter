...
//
//  STM32L4 template solution descriptor
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define PLATFORM_ARM_STM32L4 // STM32L407 cpu
...
#define SYSTEM_CLOCK_HZ                 80000000   // 80MHz
#define SYSTEM_CYCLE_CLOCK_HZ           80000000   // 80MHz
#define SYSTEM_APB1_CLOCK_HZ            80000000   // 80MHz
#define SYSTEM_APB2_CLOCK_HZ            80000000   // 80MHz
...
#define STM32L4_32B_TIMER 2 // |   2   |   5    |
#define STM32L4_16B_TIMER 3 // |3,4,8,9|1,3,8,12|


// Pin Configuration

// AD CHANNELS (ADC1 or ADC3)
#define STM32L4_ADC 1
...
#define STM32L4_AD_CHANNELS {10,11,12,13} // PC0-PC3

// PWM CHANNELS
#define STM32L4_PWM_TIMER {1,1,1,1,4,4,4,4}
#define STM32L4_PWM_CHNL  {0,1,2,3,0,1,2,3}
#define STM32L4_PWM_PINS  {8,9,10,11,22,23,24,25} // PA8-PA11,PB6-PB9

// SPI CHANNELS (SPI1 - SPIn)
#define STM32L4_SPI_SCLK_PINS {19, 29, 42} // PB3, PB13, PC10
#define STM32L4_SPI_MISO_PINS {20, 30, 43} // PB4, PB14, PC11
#define STM32L4_SPI_MOSI_PINS {21, 31, 44} // PB5, PB15, PC12

// I2C PORT (1, 2, or 3)
#define STM32L4_I2C_PORT     1
#define STM32L4_I2C_SCL_PIN  22 // PB6
#define STM32L4_I2C_SDA_PIN  23 // PB7

// UART PORTS (UART1 - UARTn)
#define STM32L4_UART_RXD_PINS {10, 54, 57, 43, 50, 39} // A10, D6, D9, C11, D2, C7
#define STM32L4_UART_TXD_PINS { 9, 53, 56, 42, 44, 38} // A9, D5, D8, C10, C12, C6
#define STM32L4_UART_CTS_PINS {11, 51, 59} // A11, D3, D11
#define STM32L4_UART_RTS_PINS {12, 52, 60} // A12, D4, D12
