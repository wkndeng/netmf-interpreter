...
#define CS_LOW  (GPIOB->BSRRH |= (0x0001 << 6))
#define CS_HIGH (GPIOB->BSRRL |= (0x0001 << 6))
#define CK_LOW  (GPIOA->BSRRH |= (0x0001 << 5))
#define CK_HIGH (GPIOA->BSRRL |= (0x0001 << 5))
#define DI_LOW  (GPIOA->BSRRH |= (0x0001 << 7))
#define DI_HIGH (GPIOA->BSRRL |= (0x0001 << 7))
#define RS_LOW  (GPIOA->BSRRH |= (0x0001 << 6))
#define RS_HIGH (GPIOA->BSRRL |= (0x0001 << 6))
#define RS_IN   (GPIOA->IDR & (0x00000001 << 6))
#define RES_LOW  (GPIOA->BSRRH |= (0x0001 << 9))
#define RES_HIGH (GPIOA->BSRRL |= (0x0001 << 9))
#endif
