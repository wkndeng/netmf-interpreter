...
//
//  Customized for NUCLEOL476RG board
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define BUTTON_PIN (2 * 16 + 13)	// PC13

#define LED (0 * 16 + 5)  			// PA5
...
bool WaitForTinyBooterUpload( INT32 &timeout_ms )
{
    ...
    timeout_ms = -1;
#else
    CPU_GPIO_EnableInputPin(BUTTON_PIN, FALSE, (GPIO_INTERRUPT_SERVICE_ROUTINE)0, GPIO_INT_NONE, RESISTOR_PULLUP);
    if(CPU_GPIO_GetPinState( BUTTON_PIN ) == FALSE)
    {
